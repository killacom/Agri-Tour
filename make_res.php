...
$pagetitle = 'Page Farms - Make A Reservation';
require_once 'header.php';
$thisfile = $_SERVER['HTTP_SELF'];
...
$contact_phone = $contact_phone_err = $contact_ext = $alt_phone = $alt_ext = '';
    ...
    if($valid) {
        ...
        if($stmt = $link->prepare($sql)) {
            ...
            if ($num_of_rows == 1) {
                ...
                $link->close();
                $to      = $contact_email;
                $subject = 'Page Farms Field Trip Confirmation Email';
                ...
                $submit_err = "Could not make reservation. Please try again or send an email with all the requested information on this form to <a href='mailto:PAGEFARMS@FRONTIER.COM'>pagefarms@frontier.com</a>";
            } 
        } else {
            $submit_err = "Could not make reservation. Please try again or send an email with all the requested information on this form to <a href='mailto:PAGEFARMS@FRONTIER.COM'>pagefarms@frontier.com</a>";
        } 
...
?>
        <main>
            <form action="<? echo $thisfile; ?>" method="POST" name="resform" class="makeres">
                <div class="section-header">Make a Reservation at Page Farms</div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="contact_first" value="<? echo $contact_first; ?>" maxlength="40" size="12"><br>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">    
                        <input type="text" name="contact_last" value="<? echo $contact_last; ?>" maxlength="40" size="12"><br>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">   
                        <input type="text" name="contact_phone" value="<? echo $contact_phone; ?>" maxlength="10" size="12">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="contact_ext" maxlength="6" value="<? echo $contact_ext; ?>" size="6">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="alt_phone" value="<? echo $alt_phone; ?>" maxlength="10" size="12"> 
                    ...
                    <div class="section-content lh">
                    <input type="text" name="alt_ext" value="<? echo $alt_ext; ?>" maxlength="6" size="6">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="contact_email" maxlength="80" value="<? echo $contact_email; ?>"> 
                ...
                <div class="row">
                    <div class="section-content rh">
                        <label for="password">Enter a Password: <input type="button" class="button" onclick="alert('<? echo $make_res_pw_info; ?>')" value="?"></label>
                    </div>
                    <div class="section-content lh">
                        <input type="password" name="password" maxlength="80">
                        <span class=error><? echo $password_err; ?></span>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="school_name" maxlength="50" value="<? echo $school_name; ?>">
                        <span class="error"><? echo $school_name_err; ?></span>
                    </div>  
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="school_addr" maxlength="80" value="<? echo $school_addr; ?>">
                        <span class="error"><? echo $school_addr_err; ?></span>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="num_children" maxlength="<? echo $max_kids_length ?>" value="<? echo $num_children; ?>"/>
                        <span class=error><? echo $num_children_err; ?></span>
                    </div> 
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="num_teachers" maxlength="3" value="<? echo $num_teachers; ?>"/>
                        <span class=error><? echo $num_teachers_err; ?></span>
                    </div> 
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        <input type="text" name="num_adults" maxlength="3" value="<? echo $num_adults; ?>"/>
                        <span class="error"><? echo $num_adults_err; ?></span>
                    </div> 
                </div>
                ...
                <div class="row">
                    ...
                    <div class="section-content lh">
                        ...
                        <select name='res_year' id='res_year'>
                            <? if($res_year==$Y){echo'<option selected=selected value='.$Y.'>'.$Y.'</option>'; }?>
                            <option <? if($res_year==$Y+1){echo'selected=selected';} ?> value="<? echo $Y+1; ?>"><? echo $Y+1; ?></option>
                        </select> 
